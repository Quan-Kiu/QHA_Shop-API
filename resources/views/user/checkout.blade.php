                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <option value="ind">Việt Nam</option>
                                    ...
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">ĐIỀU KHOẢN VÀ DỊCH VỤ</label>
                                        </div>
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                        ...
                                        <div class="custom-control custom-checkbox d-block">
                                            ...
                                            <label class="custom-control-label" for="customCheck3">ĐĂNG KÝ NHẬN THÔNG TINr</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>Cocktail Yellow dress</span> <span>550000đ</span></li>
                                <li><span>Thanh toán</span> <span>550000đ</span></li>
                                <li><span>Vận chuyển</span> <span>Free</span></li>
                                <li><span>Tổng</span> <span>550000đ</span></li>
                            </ul>
