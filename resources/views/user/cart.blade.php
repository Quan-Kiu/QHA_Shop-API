                    ...
                    <div class="col-12">
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="price"><span>550000đ</span></td>
                                        <td class="qty">
                                            <div class="quantity">
                                        ...
                                        <td class="total_price"><span>550000đ</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="cart-footer d-flex mt-30">
                            <div class="back-to-shop w-50">
                                <a href="shop-grid-left-sidebar.html">Tiếp tục mua sắm</a>
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="shipping-method-area mt-70">
                            <div class="cart-page-heading">
                                ...
                                <p>Chọn nhà vận chuyển mà bạn muốn</p>
                            </div>

                            <div class="custom-control custom-radio mb-30">
                                <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                                <label class="custom-control-label d-flex align-items-center justify-content-between" for="customRadio1"><span>Hỏa tốc</span><span>50000đ</span></label>
                            </div>

                            <div class="custom-control custom-radio mb-30">
                                <input type="radio" id="customRadio2" name="customRadio" class="custom-control-input">
                                <label class="custom-control-label d-flex align-items-center justify-content-between" for="customRadio2"><span>Giao hàng tiêu chuẩn</span><span>30000đ</span></label>
                            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-total-area mt-70">
                            ...
                            <ul class="cart-total-chart">
                                <li><span>Dự kiến</span> <span>550000đ</span></li>
                                <li><span>Phí vận chuyển</span> <span>Free</span></li>
                                <li><span><strong>Thanh toán</strong></span> <span><strong>550000đ</strong></span></li>
                            </ul>
                            <a href="/checkout" class="btn karl-checkout-btn">Tiến hành kiểm tra</a>
                        </div>
                    </div>
                </div>
            </div>
