...
<nav class="page-breadcrumb">
    <ol class="breadcrumb d-flex">
        <li class="breadcrumb-item"><a href="/colors">Màu sắc SP</a></li>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Danh sách màu</h6>
                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr id="user{{{$item->id}}}">
                                <td>{{$item['id']}}</td>
                                <td>{{$item['name']}}</td>
                                <td><button class="btn btn-primary" onclick="window.location.href='colors/{{{$item->id}}}' ;">Sửa </button></td>
